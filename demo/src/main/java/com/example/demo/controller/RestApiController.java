...
public class RestApiController {
  ...
  public Map<String, Map<String, String>> getExpenseById(
    @PathVariable String expenseId
  ) {
    Expense expenseById = expenseService.getExpenseById(
  ...
  @GetMapping(value = "/edit/category/{categoryId}")
  public Map<String, String> getCategoryById(@PathVariable String categoryId) {
    Category categoryById = categoryService.getCategoryById(
      UUID.fromString(categoryId)
    );

    Map<String, String> categoryMap = new HashMap<>();
    categoryMap.put("categoryId", String.valueOf(categoryById.getCategoryId()));
    categoryMap.put("name", categoryById.getName());
